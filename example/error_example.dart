import 'package:nekos_best/nekos_best.dart' show fetch, NBError, NBArgumentError;
...
void main() async {
  ...
  } on NBError catch (e) { // Catch on an NBError
  ...
  } catch (e) { // Unknown error that wasnt give from the library
